...
CREATE TABLE [Orders] (
	destination_city_id int NOT NULL FOREIGN KEY REFERENCES Cities (city_id),
	ship_from_city_id int NOT NULL FOREIGN KEY REFERENCES Cities (city_id),
...
CREATE TABLE [OrderGoodsPair] (
	order_id int NOT NULL FOREIGN KEY REFERENCES Orders (order_id),-- int IDENTITY(1,1) NOT NULL CONSTRAINT PK_OrderGoodsPair PRIMARY KEY,
	weight float NOT NULL,
	amount int NOT NULL,
	goods_id int NOT NULL FOREIGN KEY REFERENCES Goods (goods_id),
...
CREATE TABLE [Cars] (
	car_id int IDENTITY(1,1) NOT NULL CONSTRAINT PK_Cars PRIMARY KEY, -- int IDENTITY(1,1) NOT NULL
...
CREATE TABLE [Drivers] (
	...
	driver_licence_category varchar(255) NOT NULL
)
GO
...
CREATE TABLE [OrderTripPair] (
	trip_id int NOT NULL FOREIGN KEY REFERENCES Trips (trip_id),-- IDENTITY(1,1) NOT NULL CONSTRAINT PK_OrderTripPair PRIMARY KEY,
