...
VALUES
	...
	('Merida', 'красный', 'велосипед', 0.030, 1, 20.2, 0);
...
VALUES
	...
	(1116233334533, 'Максим', 'Ш', 111111111, 1, 0000000001, 'B, C, D');
...
VALUES
	('Kingston KVR16S11S8/4', 'Модуль памяти', 1.95, 'Хрупкий'), 
	('Беговая дорожка Kettler Track 3', 'Беговая дорожка', 63.9, 'Хрупкий'),
	('Царь-пушка', 'Пушка', 456, 'Опасный'),
	('Кубок чемпиона', 'Кубок', 77, 'Особо опасный'),
	('Sony PlayStation 4', 'Игровая приставка', 12, 'Хрупкий');
