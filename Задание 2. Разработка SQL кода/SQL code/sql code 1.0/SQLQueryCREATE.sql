...
CREATE TABLE [Dues] (
	destination_country_id bigint NOT NULL FOREIGN KEY REFERENCES [Countries]([country_id]),-- IDENTITY(1,1) NOT NULL CONSTRAINT PK_Dues PRIMARY KEY,
...
CREATE TABLE [Cities] (	
	...
	region_id bigint NOT NULL FOREIGN KEY REFERENCES Regions (region_id),
	country_id bigint NOT NULL FOREIGN KEY REFERENCES Countries (country_id),
...
CREATE TABLE [Clients] (
	address bigint NOT NULL FOREIGN KEY ([address]) REFERENCES [Cities]([city_id]),
...
CREATE TABLE [Orders] (
	destination_city_id bigint NOT NULL FOREIGN KEY REFERENCES Cities (city_id),
	ship_from_city_id bigint NOT NULL FOREIGN KEY REFERENCES Cities (city_id),
	order_id bigint IDENTITY(1,1) NOT NULL CONSTRAINT PK_Orders PRIMARY KEY,
	order_status nvarchar(255) NOT NULL,
	profit float NOT NULL,
	client_id bigint NOT NULL FOREIGN KEY REFERENCES Clients (client_id),
...
CREATE TABLE [OrderGoodsPair] (
	order_id bigint NOT NULL FOREIGN KEY REFERENCES Orders (order_id),-- int IDENTITY(1,1) NOT NULL CONSTRAINT PK_OrderGoodsPair PRIMARY KEY,
	weight float NOT NULL,
	amount bigint NOT NULL,
	goods_id bigint NOT NULL FOREIGN KEY REFERENCES Goods (goods_id),
...
CREATE TABLE [Trips] (
	...
	driver_id bigint NOT NULL FOREIGN KEY REFERENCES Drivers (driver_id),
	car_id bigint NOT NULL FOREIGN KEY REFERENCES Cars (car_id),
...
CREATE TABLE [OrderTripPair] (
	trip_id bigint NOT NULL FOREIGN KEY REFERENCES Trips (trip_id),-- IDENTITY(1,1) NOT NULL CONSTRAINT PK_OrderTripPair PRIMARY KEY,
	order_id bigint NOT NULL FOREIGN KEY ([order_id]) REFERENCES [Orders]([order_id]),
