...
--процедура, возвращающая множество четверок "id водителя, имя водителя, фамилия водителя, количество проезженных километров" (DriversCursor OUTPUT)
...
--получение доходов предприятия по годам за все время (ResultCurcor OUTPUT)
----------------------------------------------------------------
----------------------------------------------------------------
...
----------------------------------------------------------------
--процедура, возвращающая множество четверок "id водителя, имя водителя, фамилия водителя, количество проезженных километров"
...
BEGIN 
	SET @Result = 0
	PRINT 'Нет заказов за этот период'
END
ELSE
BEGIN
...
----------------------------------------------------------------
--получение доходов предприятия по годам за все время
...
BEGIN
	...
	', Абсолютный рост: ', CONVERT(bigint, @profit) - CONVERT(bigint, @prev_profit), 
